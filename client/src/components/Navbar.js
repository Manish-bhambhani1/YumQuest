...
const [searchQuery, setSearchQuery] = useState("");
  ...
  const handleSearch = (event) => {
    ...
    axios
      .get("http://localhost:5000/api/sample/getAll")
      .then((response) => {
    ...
    <nav className="navbar navbar-expand-lg navbar-nav">
      <div className="container-fluid">
        ...
        <img
          ...
          muted
          loop
          style={{ width: '5.5%', height: '5.5%', objectFit: 'fit', margin: '-10px' }}
        />

        <div className="collapse navbar-collapse" id="navbarColor01" style={{ marginLeft: '5px' }}>
  ...
  aria-label="Search"
  value={searchQuery}
  onChange={(e) => setSearchQuery(e.target.value)}  style={{ width: '400px ' }}
/>
  ...
  Search
          ...
          {uniqueCuisines
            ...
            .map((item) => (
              ...
              {loading && <p>Loading...</p>} {/* Display loading message when loading is true */}
