...
const [showCaption, setShowCaption] = useState(false);
  ...
  return (
    <div className="parent-container">
      ...
      >
        ...
        <button className="buttoncaption"
 ...
 <div className="comments">
                  <button className="buttoncomment" onClick={() => changedcontent(props)}>Comments</button>
                  </div>
      {popuptogle && (
        <div className="pop_up_containers"     onClick={changedcontent}>
          <div className="pop_up_bodys"  style={styling} onClick={(e) => e.stopPropagation()}>
